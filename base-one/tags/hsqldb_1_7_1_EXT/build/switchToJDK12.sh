...
echo "$jdkhome/bin/java" -classpath "$cp:../classes" org.hsqldb.util.CodeSwitcher ../src/org/hsqldb/HsqlDatabaseProperties.java +JAVA2
"$jdkhome/bin/java" -classpath "$cp:../classes" org.hsqldb.util.CodeSwitcher ../src/org/hsqldb/HsqlDatabaseProperties.java +JAVA2
